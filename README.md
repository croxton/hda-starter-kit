...
* [Alpine.js](https://alpinejs.dev/) for composing behaviour directly in markup, with support for asynchronous on-demand components via [Async Alpine](https://github.com/Accudio/async-alpine)
* [Vue.js](https://vuejs.org/) (Vue 3) for complex reactive applications using SFCs
